...
def generate_price_recommendation(selected_product, product_data_with_predictions, sentiments):
    ...
    **Task:**
    ...
    - Recommend an **optimal selling price in Indian Rupees (₹)** that balances **profitability and sales**.
...
def chatbot_response(user_query, selected_product, product_data_with_predictions, sentiments):
    ...
    chat_prompt = f"""
You are an expert e-commerce analyst. Based on the following product data, answer the user's query in  discount percentages and avoid using any other currency.    
